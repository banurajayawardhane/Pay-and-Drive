...
<div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Police Fine History</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        ...
        <form action="" method="post">
            <div class="form-row">
            <div class="col-md-5">
            <input type="text" placeholder="Enter Police ID" name="police_id" class="form-control" required>
              </div>
              <div class="col-md-1">
...
<br>
        <?php
          ...
          if(isset($_POST['search']))
          {
            ...
            $query = "SELECT * FROM fines where police_id= '$police_id'";
